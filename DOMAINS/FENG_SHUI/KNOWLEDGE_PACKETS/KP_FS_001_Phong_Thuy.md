...
dependencies:
  ...
  - DOMAINS/FENG_SHUI/SOURCES/RESEARCH_DRAFT_GAP_CLOSURE_2026_07.md
  - DOMAIN_SPECIFICATION/KNOWLEDGE_PACKET_SCHEMA.md
source_lineage: Tổng hợp 3 research draft (2026-07-17). Tier 1 (đồng thuận cổ điển) cho hai chu kỳ Tương Sinh/Tương Khắc Ngũ Hành và bảng Bát Quái Hậu Thiên. Tier 3 (thực hành phổ biến đương đại, đối chiếu ≥2-3 nguồn độc lập/mục) cho phần lớn nội dung ứng dụng nhà ở và các chi tiết trường phái Tử Vi liên quan. Cập nhật 2026-07-24: `RESEARCH_DRAFT_GAP_CLOSURE_2026_07.md` xác nhận 3 nguồn Tier 4 học thuật thực sự cho lớp lịch sử-khung của Phong Thủy (Ole Bruun, Michael Paton, Richard J. Smith — xem Canonical Sources) — dùng cho khung lịch sử-xã hội tổng quát; KHÔNG dùng để nâng cấp bất kỳ trích dẫn cụ thể nào (ví dụ Táng Thư/Quách Phác) mà chưa được đối chiếu trực tiếp nội dung bản dịch, xem "Khoảng trống nguồn" trong Canonical Sources.
...
| Status | draft-pending-human-review |
| Version | 0.2 |
| Last Updated | 2026-07-24 (bổ sung 3 nguồn Tier 4 học thuật cho Phong Thủy — xem `RESEARCH_DRAFT_GAP_CLOSURE_2026_07.md`) |
...
Phong Thủy không có một văn bản kinh điển duy nhất như Kinh Địa Tạng có cho domain Phật giáo — đây là một truyền thống sống với nhiều trường phái/lineage cạnh tranh (`DOMAIN_GUIDE.md` §2). **Cập nhật 2026-07-24 (nguồn Tier 4 mới xác định):** khung "truyền thống sống, không có văn bản kinh điển duy nhất, tiếp tục biến đổi qua các giai đoạn lịch sử-xã hội khác nhau" nay có thể dẫn tới học thuật thực sự — Ole Bruun's *Fengshui in China* ghi nhận phong thủy Trung Quốc như một thực hành tiếp tục sống động và biến đổi qua các giai đoạn nhà nước-chính thống/tôn giáo dân gian khác nhau (dựa điền dã thực địa), và Richard J. Smith's "The Transnational Travels of Geomancy in Premodern East Asia" ghi nhận sự lan tỏa xuyên quốc gia của lý thuyết/thực hành phong thủy tại Đông Á giai đoạn 1600-1900. Đây là khung tổng quát được các nguồn học thuật này hỗ trợ thật; packet này chưa dùng chúng để xác nhận bất kỳ chi tiết cụ thể nào về quá trình tiếp biến vào Việt Nam (xem "Nguồn học thuật Tier 4 mới xác định," Canonical Sources). Khi tiếp biến vào văn hóa Việt Nam, kiến trúc nhà truyền thống (nhà quay lưng vào núi/gò, nhìn ra ao/sông) là một minh chứng văn hóa gần gũi cho nguyên lý Loan Đầu — thuộc lớp "cultural/historical" theo `DOMAIN_GUIDE.md` §10, không cần khẳng định tính hiệu quả.
...
3. **Tính xác thực trích dẫn Táng Thư/Quách Phác** — nguyên lý "khí gặp gió tán, gặp nước dừng" được lưu truyền rộng rãi trong giới thực hành nhưng việc xác thực văn bản gốc chưa qua chỉnh sửa qua các đời có độ tin cậy thấp hơn; chỉ nên diễn giải ý, ghi "tương truyền." **Cập nhật 2026-07-24:** một bản dịch học thuật đầy đủ của Táng Thư nay đã được xác định tồn tại — Michael Paton, *Five Classics of Fengshui* (Brill, 2013), xem "Nguồn học thuật Tier 4 mới xác định" ở Canonical Sources — nhưng packet này chưa đối chiếu trực tiếp bản dịch đó với câu diễn giải đang dùng, nên độ tin cậy của bản thân trích dẫn vẫn giữ nguyên ở mức trung bình cho tới khi có bước xác minh riêng; chỉ mức tin cậy về việc "tồn tại một nguồn học thuật uy tín có thể dùng để xác minh sau này" được nâng lên cao.
...
| `SOURCES/RESEARCH_DRAFT_GAP_CLOSURE_2026_07.md` | Nghiên cứu bổ sung (2026-07-24) đóng khoảng trống Tier 4 cho Phong Thủy: xác nhận qua tìm kiếm/tra cứu trực tiếp 3 nguồn học thuật thực sự (Ole Bruun ×2, Michael Paton, Richard J. Smith) | Cao cho việc các nguồn này tồn tại, là học thuật thật (nhà xuất bản đại học/tạp chí bình duyệt), và phạm vi bao quát của chúng; trung bình cho nội dung chi tiết bên trong (chưa đọc toàn văn) | Dùng để nâng cấp Source Priority Hierarchy Tier 4 (Phong Thủy) bên dưới và bổ sung mục "Nguồn học thuật Tier 4 mới xác định"; KHÔNG dùng để nâng cấp nội dung một trích dẫn cụ thể (ví dụ Táng Thư/Quách Phác) chưa được đối chiếu trực tiếp |
...
| 4 | Học thuật/lịch sử về nguồn gốc và lịch sử xã hội | Dùng cho lớp lịch sử-khung (Historical Background) — **cập nhật 2026-07-24: đã xác định 3 nguồn học thuật thực sự cho Phong Thủy** (Ole Bruun, Michael Paton, Richard J. Smith — xem mục "Nguồn học thuật Tier 4 mới xác định" ngay bên dưới); dùng cho khung lịch sử-xã hội tổng quát, chưa dùng để nâng cấp một trích dẫn cụ thể nào chưa được đối chiếu nội dung trực tiếp |

## Nguồn học thuật Tier 4 mới xác định (2026-07-24, cho Phong Thủy)

Bổ sung từ `RESEARCH_DRAFT_GAP_CLOSURE_2026_07.md` mục 1, đóng khoảng trống Tier 4 đã ghi ở "Khoảng trống nguồn" bên dưới. Bốn nguồn này được xác minh **tồn tại thật, là học thuật nghiêm túc** (không phải trang thực hành/thương mại) qua tìm kiếm/tra cứu trực tiếp ngày 2026-07-24 — độ tin cậy **cao** cho sự tồn tại/phạm vi/uy tín học thuật, độ tin cậy **trung bình** cho nội dung chi tiết bên trong (chưa đọc toàn văn, chỉ xác minh mục lục/mô tả/review):

1. **Ole Bruun, *Fengshui in China: Geomantic Divination Between State Orthodoxy and Popular Religion*** (NIAS Press/University of Hawai'i Press, 2003) — nghiên cứu nhân học dựa trên điền dã thực địa tại Tứ Xuyên và Giang Tô, kết hợp khảo cứu ~150 năm lịch sử gần đây của phong thủy tại Trung Quốc; lời tựa của Stephan Feuchtwang. Dùng cho khung lịch sử-xã hội tổng quát của Phong Thủy đương đại (Historical Development).
2. **Ole Bruun, *An Introduction to Feng Shui*** (Cambridge University Press, 2011) — bản giới thiệu học thuật cô đọng hơn, cùng tác giả.
3. **Michael Paton, *Five Classics of Fengshui: Chinese Spiritual Geography in Historical and Environmental Perspective*** (Brill, Sinica Leidensia, 2013) — bản dịch học thuật đầy đủ 5 văn bản cổ điển Phong Thủy, bao gồm chính Táng Thư (Book of Burial) tương truyền của Quách Phác. Đây là ứng viên mạnh nhất để trong tương lai đối chiếu và nâng cấp trích dẫn Táng Thư/Quách Phác hiện đang ở độ tin cậy trung bình trong packet này (xem Historical Debates mục 3 và Loan Đầu bên dưới) — **nhưng packet này chưa đối chiếu trực tiếp bản dịch của Paton**, nên nội dung trích dẫn cụ thể GIỮ NGUYÊN mức tin cậy trung bình cho tới khi có bước xác minh riêng.
4. **Richard J. Smith, "The Transnational Travels of Geomancy in Premodern East Asia, c. 1600–c. 1900"** (2 phần, *Transnational Asia*, tập 2 số 1, 2019, Rice University) — dùng cho khung lan tỏa xuyên quốc gia của phong thủy tại Đông Á, có thể hữu ích cho một khảo sát sâu hơn về sự tiếp biến của Phong Thủy vào Việt Nam trong tương lai (hiện packet chưa dùng cụ thể cho phần tiếp biến Việt Nam — đây là gợi ý cho nghiên cứu tiếp theo, không phải một claim đã đưa vào).

**Về Tử Vi:** báo cáo trên cũng tìm được một ứng viên Tier 4 khả tín cho riêng nhánh Tử Vi (Ho Peng Yoke) — ghi nhận trong `KP_FS_002_Tu_Vi.md`, không lặp lại ở đây vì packet này không đi sâu Tử Vi (xem `secondary_context` ở Packet Control).

## Khoảng trống nguồn (Known Gaps)

- **Cập nhật 2026-07-24:** khoảng trống "chưa có nguồn academic/dân tộc học tier 4 nào được truy cập" đã được đóng ở mức tồn tại/uy tín cho riêng nhánh Phong Thủy (xem "Nguồn học thuật Tier 4 mới xác định" ở trên) — 3 nguồn học thuật thật đã được xác nhận. Đây KHÔNG có nghĩa mọi claim lịch sử trong packet đã được nâng cấp: chỉ khung lịch sử-xã hội tổng quát được củng cố; các trích dẫn cụ thể (đặc biệt Táng Thư/Quách Phác) vẫn cần một bước đối chiếu nội dung trực tiếp trước khi đổi nhãn tin cậy riêng của chúng.
...
- Nhãn độ tin cậy: cách truyền thống mô tả khí (ẩn dụ gió/nước, sinh khí/tà khí, vai trò khác nhau theo trường phái) đối chiếu nhất quán qua 2 nhóm nguồn độc lập thực sự có trong 3 research draft nền tảng của packet này (thực hành phổ thông tiếng Việt; thực hành phổ thông tiếng Anh của nhánh Loan Đầu/Form School) — mức tin cậy trung bình cho phần "cách truyền thống mô tả khí." **Sửa sau QA:** packet **chưa từng** tiếp cận một nguồn học thuật/phê phán phong thủy độc lập nào (xem "Khoảng trống nguồn," Canonical Sources) — không được đếm đó như một tầng nguồn thứ ba đã xác minh. Kết luận an toàn (khí không phải hiện tượng vật lý đã được khoa học xác nhận) vẫn đứng vững, vì nó dựa trên sự **vắng mặt** của bất kỳ nguồn nào — kể cả nguồn ủng hộ phong thủy — từng đưa ra bằng chứng đo lường được, không dựa trên một nguồn phản bác cụ thể. Bất kỳ tuyên bố nào rằng khí là hiện tượng vật lý đã được khoa học xác nhận có mức tin cậy: **không có nguồn nào xác nhận** — phải bị loại khỏi kịch bản, không chỉ gắn nhãn thấp.
