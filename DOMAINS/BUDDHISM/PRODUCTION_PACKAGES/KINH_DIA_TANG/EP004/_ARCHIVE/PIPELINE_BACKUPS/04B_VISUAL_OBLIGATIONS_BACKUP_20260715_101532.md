...
- Required Continuity: None (mặc dù "ngọn đèn" sẽ được nhắc lại ở BEAT_121/125/157 — 04A không xác nhận đây có phải cùng một continuity object hay các lần dùng ẩn dụ độc lập; ghi nhận thận trọng: không ép buộc continuity giữa các lần dùng "đèn" nếu 04A không xác nhận rõ)
...
- Required Subject: cha mẹ (còn sống/đã mất), gia đình, sự an toàn, nỗi nhớ
- Required Action: chăm sóc bằng sự có mặt thật hơn; biến nỗi nhớ thành đời sống tử tế hơn; giữ an toàn cho mình
- Required Setting: Setting intentionally unspecified.
- Required Visual Evidence: 3 nhánh hướng dẫn tương ứng 3 hoàn cảnh — mỗi nhánh là một hành vi/thái độ trừu tượng (chăm sóc thật hơn, sống tử tế hơn, giữ an toàn), không có hành vi cụ thể duy nhất nào được narration chỉ định
- Visualizable Type: Abstract — có chủ thể (cha mẹ, khán giả ngầm định) nhưng nội dung là hướng dẫn thái độ sống, không có hành vi cụ thể tức thời
- Visualization Strategy: mô tả dấu hiệu quan sát được — nếu cần, một cử chỉ chăm sóc ấm áp (nhánh 1), một khoảnh khắc suy tư tử tế (nhánh 2), một tư thế giữ khoảng cách an toàn nhưng không thù hận (nhánh 3) — ba dấu hiệu độc lập, không bắt buộc đồng thời
- Required Continuity: None.
- Forbidden Hallucination: None thêm ngoài phạm vi 3 nhánh đã liệt kê.
- Visual Importance: Medium
