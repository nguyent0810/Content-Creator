# EP_BUD_KDT_005_SHORT_01 Content Package

Vertical Short (mode: Myth-Bust) derived from PKG_BUD_KDT_EP005 (Long-form). Standalone unit; does not require the Long-form episode as prerequisite viewing.
