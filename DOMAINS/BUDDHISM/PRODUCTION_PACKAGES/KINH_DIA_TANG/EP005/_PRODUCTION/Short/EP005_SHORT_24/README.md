# EP_BUD_KDT_005_SHORT_24 Content Package

Vertical Short (mode: Quote/Reflection) derived from PKG_BUD_KDT_EP005 (Long-form). Standalone unit; does not require the Long-form episode as prerequisite viewing.
