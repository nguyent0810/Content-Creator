# EP_BUD_KDT_005_SHORT_16 Content Package

Vertical Short (mode: quote_reflection) derived from PKG_BUD_KDT_EP005 (Long-form). Standalone unit; does not require the Long-form episode as prerequisite viewing.
