# EP_BUD_KDT_001_SHORT_17 Content Package

Vertical Short (mode: quote_reflection) derived from PKG_BUD_KDT_EP001 (Long-form). Standalone unit; does not require the Long-form episode as prerequisite viewing.
