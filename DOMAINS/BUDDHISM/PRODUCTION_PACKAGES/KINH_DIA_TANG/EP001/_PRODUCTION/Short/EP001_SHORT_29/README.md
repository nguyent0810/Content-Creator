# EP_BUD_KDT_001_SHORT_29 Content Package

Vertical Short (mode: symbol_decode) derived from PKG_BUD_KDT_EP001 (Long-form). Standalone unit; does not require the Long-form episode as prerequisite viewing.
