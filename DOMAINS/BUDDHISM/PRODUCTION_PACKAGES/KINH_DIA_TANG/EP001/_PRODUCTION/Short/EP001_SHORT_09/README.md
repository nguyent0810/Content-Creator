# EP_BUD_KDT_001_SHORT_09 Content Package

Vertical Short (mode: Story Beat) derived from PKG_BUD_KDT_EP001 (Long-form). Standalone unit; does not require the Long-form episode as prerequisite viewing.
