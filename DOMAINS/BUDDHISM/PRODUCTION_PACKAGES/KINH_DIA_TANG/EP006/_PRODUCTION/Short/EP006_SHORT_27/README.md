# EP_BUD_KDT_006_SHORT_27 Content Package

Vertical Short (mode: Modern Application) derived from PKG_BUD_KDT_EP006 (Long-form). Standalone unit; does not require the Long-form episode as prerequisite viewing.
