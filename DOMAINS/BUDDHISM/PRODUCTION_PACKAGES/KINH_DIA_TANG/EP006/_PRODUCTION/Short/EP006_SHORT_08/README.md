# EP_BUD_KDT_006_SHORT_08 Content Package

Vertical Short (mode: Symbol Decode) derived from PKG_BUD_KDT_EP006 (Long-form). Standalone unit; does not require the Long-form episode as prerequisite viewing.
